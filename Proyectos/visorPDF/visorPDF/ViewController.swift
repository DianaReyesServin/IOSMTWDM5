...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var listaTitulos = ["Clean code", "Javascript", "Definitive Guide", "Mastering regular expressions", "Titulo4", "Titulo5", "Titulo6", "Titulo7", "Titulo8", "Titulo9", "Titulo10"]
    var listaArchivos = ["pdf1", "pdf2", "pdf3", "pdf4","pdf5", "pdf6", "pdf7", "pdf8", "pdf9", "pdf10"]
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if(editingStyle == .delete){
            let refreshAlert = UIAlertController(title: "¿Estás seguro?", message: "Se eliminará" + listaArchivos[indexPath.row], preferredStyle: .alert)
